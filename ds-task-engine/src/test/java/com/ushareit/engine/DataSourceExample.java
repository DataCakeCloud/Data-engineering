...
//        ta.setColumns(columns);
        ...
        List<Map<String, Object>> mysql = DataSourceUtil.getTables("test-datasource", JSONObject.toJSONString(runtimeConfig),
                "mysql", "{\"jdbc_url_params\":\"useUnicode=true&characterEncoding=UTF-8&useSSL=false\",\"password\":\"123456\",\"database\":\"query_editor\",\"port\":3306,\"replication_method\":\"STANDARD\",\"host\":\"127.0.0.1\",\"ssl\":false,\"tunnel_method\":{\"tunnel_method\":\"NO_TUNNEL\"},\"username\":\"query_editor\"}");
