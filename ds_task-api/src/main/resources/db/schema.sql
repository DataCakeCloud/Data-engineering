create table if not exists  ds_task.`access_tenant` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(128) DEFAULT NULL COMMENT '名称',
  `manager_email` varchar(1000) DEFAULT NULL COMMENT '管理者邮箱',
  `description` varchar(512) DEFAULT NULL COMMENT '备注',
  `config` varchar(1000) DEFAULT NULL COMMENT '租户配置',
  `is_master` varchar(1) DEFAULT '1' COMMENT '是否是主账号',
...
create table if not exists ds_task.access_group
(
	id int auto_increment comment '主键' ,
  `name` varchar(128) DEFAULT NULL COMMENT '名称',
  `e_name` varchar(128) DEFAULT NULL COMMENT '部门别名',
  `director` varchar(128) DEFAULT NULL COMMENT '负责人',
...
create table if not exists ds_task.access_menu
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.access_product
(
...
create table if not exists ds_task.access_role
(
	id int auto_increment comment '主键'
		primary key,
	name varchar(128) null comment '名称',
...
create table if not exists ds_task.access_role_menu
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.access_user
(
	id int auto_increment comment '主键'
		primary key,
	name varchar(128) null comment '名称',
...
create table if not exists ds_task.access_user_group
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.access_user_role
(
	id int auto_increment comment '主键'
		primary key,
	user_id int not null comment '用户id',
...
create table if not exists ds_task.access_tenant_group(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
create table if not exists ds_task.access_tenant_product
(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` int(11) NOT NULL COMMENT '租户id',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建人',
...
create table if not exists ds_task.access_tenant_role
(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` int(11) NOT NULL COMMENT '租户id',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建人',
...
create table if not exists ds_task.account
(
...
create table if not exists ds_task.accumulate_online_task
(
	id int auto_increment comment '主键' primary key,
...
create table if not exists ds_task.accumulate_user
(
	id int auto_increment comment '主键'
		primary key,
	date varchar(128) null comment '日期',
...
create table if not exists ds_task.actor
(
    ...
    `create_user_group_uuid` varchar(200) DEFAULT NULL COMMENT '创建时用户组',
...
create table if not exists ds_task.actor_catalog
(
	id int auto_increment primary key,
...
create table if not exists ds_task.actor_definition
(
	id int auto_increment primary key,
...
create table if not exists ds_task.advice
(
	id int auto_increment primary key,
...
create table if not exists ds_task.announcement
(
	id int auto_increment comment '主键'primary key,
...
create table if not exists ds_task.artifact
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.artifact_version
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.attachment
(
...
create table if not exists ds_task.auditlog
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task.cost_allocation
(
...
create table if not exists ds_task.cost_monitor
(
...
create table if not exists ds_task.cost_monitor_notice
(
	id bigint auto_increment
		primary key,
...
create table if not exists ds_task.dept_info
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.dictionary
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.ds_indicators
(
	id int auto_increment comment '自增id'
		primary key,
	project varchar(100) default 'dataStudio' null comment '项目名称',
	dt varchar(50) default '' not null comment '天',
	indicators varchar(50) default '' not null comment '指标名称',
...
create table if not exists ds_task.ds_indicators_statistical_new
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.duty_info
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task.dynamic_form
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.feedback
(
	id int auto_increment
		primary key,
	tenant_id int(11) DEFAULT NULL COMMENT '租户id',
...
create table if not exists ds_task.feedback_process_item
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task.flink_cluster
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.hive_tables
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.label
(
	id int auto_increment comment '主键'
		primary key,
...
comment 'label表 ' charset=utf8;

create table if not exists ds_task.label_collect
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.lock_info
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.operate_log
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task.spark_log_url
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.sys_dict
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.task
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.task_instance
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.task_par_change
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.task_scale_strategy
(
	id int auto_increment comment '主键'
		primary key,
	task_id int null comment '任务ID',
...
create table if not exists ds_task.task_snapshot
(
	id int(11) unsigned auto_increment
		primary key,
...
create table if not exists ds_task.task_version
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.template_region_imp
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.workflow
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.workflow_task
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task.workflow_version
(
...
create table if not exists ds_task.spark_param_restrict
(
	 `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task.`user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task.`user_group_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task.`task_folder` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task.`task_folder_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `ds_task`.`aksk` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ak` varchar(50) DEFAULT NULL,
  `sk` varchar(50) DEFAULT NULL,
  `tenant_name` varchar(255) DEFAULT NULL COMMENT '租户',
  `tenant_id` int(20) NOT NULL,
  `valid` tinyint(1) DEFAULT '0' COMMENT '是否有效',
  `apply_user_id` varchar(255) DEFAULT NULL COMMENT '申请人id',
...
CREATE TABLE IF NOT EXISTS `ds_task`.`aksk_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(255) DEFAULT NULL,
  `tenant_name` varchar(255) DEFAULT NULL COMMENT '租户',
  `tenant_id` int(20) NOT NULL COMMENT '租户id',
  `is_admin` tinyint(1) DEFAULT '0' COMMENT '是否为管理员 0：不是；1：是',
  `user_name` varchar(200) DEFAULT NULL COMMENT '用户名',
  `effective_time` int(11) DEFAULT '0' COMMENT '有效时间/天',
  `expiration` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人员',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS `ds_task`.`wechat_alert` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(200) ,
  `token` varchar(200),
...
CREATE TABLE IF NOT EXISTS `ds_task`.`file_manager` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id,也代表文件夹或文件id',
  `entity_id` int(11) DEFAULT NULL COMMENT '文件的外部实体id,比如任务id，工件id',
  `name` varchar(300) NOT NULL COMMENT '文件、文件夹的名称',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT '父节点id',
  `file_nums` int(11) NOT NULL DEFAULT '0' COMMENT '文件夹的所有子文件数',
  `module` varchar(50) NOT NULL COMMENT '类型：工件、任务',
  `user_group` varchar(100) NOT NULL COMMENT '用户组uuid',
  `is_folder` tinyint(2) NOT NULL COMMENT '是否为文件',
  PRIMARY KEY (`id`),
  KEY `index_parent_id` (`parent_id`),
  KEY `index_module_name` (`module`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=8906 DEFAULT CHARSET=utf8mb4;