create table if not exists  ds_task1.`access_tenant` (
...
create table if not exists ds_task1.access_group
(
...
create table if not exists ds_task1.access_menu
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.access_product
(
...
create table if not exists ds_task1.access_role
(
	id int auto_increment comment '主键'
		primary key,
	name varchar(128) null comment '名称',
...
create table if not exists ds_task1.access_role_menu
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.access_user
(
	id int auto_increment comment '主键'
		primary key,
	name varchar(128) null comment '名称',
...
create table if not exists ds_task1.access_user_group
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.access_user_role
(
	id int auto_increment comment '主键'
		primary key,
	user_id int not null comment '用户id',
...
create table if not exists ds_task1.access_tenant_group(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
create table if not exists ds_task1.access_tenant_product
(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` int(11) NOT NULL COMMENT '租户id',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建人',
...
create table if not exists ds_task1.access_tenant_role
(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` int(11) NOT NULL COMMENT '租户id',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建人',
...
create table if not exists ds_task1.account
(
...
create table if not exists ds_task1.accumulate_online_task
(
	id int auto_increment comment '主键' primary key,
...
create table if not exists ds_task1.accumulate_user
(
	id int auto_increment comment '主键'
		primary key,
	date varchar(128) null comment '日期',
...
create table if not exists ds_task1.actor
(
	...
	groups varchar(2000) DEFAULT '' COMMENT '部门信息',
...
create table if not exists ds_task1.actor_catalog
(
	id int auto_increment primary key,
...
create table if not exists ds_task1.actor_definition
(
	id int auto_increment primary key,
...
create table if not exists ds_task1.advice
(
	id int auto_increment primary key,
	app_name varchar(500) default 'ds_task1' null comment '产品名称',
...
create table if not exists ds_task1.announcement
(
	id int auto_increment comment '主键'primary key,
...
create table if not exists ds_task1.artifact
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.artifact_version
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.attachment
(
...
create table if not exists ds_task1.auditlog
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task1.cost_allocation
(
...
create table if not exists ds_task1.cost_monitor
(
...
create table if not exists ds_task1.cost_monitor_notice
(
	id bigint auto_increment
		primary key,
...
create table if not exists ds_task1.dept_info
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.dictionary
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.ds_indicators
(
...
create table if not exists ds_task1.ds_indicators_statistical_new
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.duty_info
(
	id int auto_increment
		primary key,
	tenant_id int null comment '租户id',
...
create table if not exists ds_task1.dynamic_form
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.feedback
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task1.feedback_process_item
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task1.flink_cluster
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.hive_tables
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.label
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.label_collect
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.lock_info
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.operate_log
(
	id int auto_increment
		primary key,
...
create table if not exists ds_task1.spark_log_url
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.sys_dict
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.task
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.task_instance
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.task_par_change
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.task_scale_strategy
(
	id int auto_increment comment '主键'
		primary key,
	task_id int null comment '任务ID',
...
create table if not exists ds_task1.task_snapshot
(
	id int(11) unsigned auto_increment
		primary key,
...
create table if not exists ds_task1.task_version
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.template_region_imp
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.workflow
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.workflow_task
(
	id int auto_increment comment '主键'
		primary key,
...
create table if not exists ds_task1.workflow_version
(
...
create table if not exists ds_task1.spark_param_restrict
(
	 `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task1.`user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task1.`user_group_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task1.`task_folder` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE  if not exists ds_task1.`task_folder_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `ds_task1`.`aksk` (
...
CREATE TABLE IF NOT EXISTS `ds_task1`.`aksk_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
