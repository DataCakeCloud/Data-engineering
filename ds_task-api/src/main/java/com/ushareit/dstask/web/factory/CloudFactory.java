...
public class CloudFactory {
    ...
    public CloudBaseClientUtil getCloudClientUtilByProvider(String Provider) {
        ...
        switch (Provider) {
            ...
            case "aliyuncloud":
                ...
                ossClientUtil.cloudResourcesService = cloudResourcesService;
                ossClientUtil.dataCakeRegionProperties = dataCakeRegionProperties;
    ...
    public CloudBaseClientUtil getCloudClientUtilByUrl(String url) {
        ...
        if (url.contains("amazonaws.com") || url.startsWith("s3://")) {
            ...
            provider = "ks3cloud";
        } else if (url.contains("aliyuncs.com") || url.startsWith("oss://")) {
            provider = "aliyuncloud";
        } else {
