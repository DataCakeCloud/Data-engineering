...
public class SourceController {
    ...
    public BaseResponse<?> create(@RequestBody @Valid SourceCreate sourceCreate) {
        ...
        String where = String.format(" actor_definition_id = %d and groups = %s and",sourceCreate.getSourceDefinitionId(),sourceCreate.getGroups()) ;
    ...
    public BaseResponse<SourceRead> get(@RequestParam("sourceId") Integer sourceId) {
        ...
        return BaseResponse.success(new SourceRead(actor, definitionMap));
    }
    ...
    public BaseResponse<PageInfo<SourceRead>> page(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        return BaseResponse.success(PageUtils.map(pageInfo, item -> new SourceRead(item, definitionMap)));
    }
