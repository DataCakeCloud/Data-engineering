    ...
    public static Configuration getFileSystemConf(String accessKey,String accessSecret,String implClass,String defaultFS,String type) throws IOException {
        ...
        switch (type){
            ...
            case "ks3":
                ...
                break;
            case "hdfs":
                System.setProperty("java.security.krb5.conf", "/Users/shareit/ds_task/ds_task-api/src/main/resources/kerberos-conf/krb5.conf");
                conf.set("hadoop.security.authentication","kerberos");
                conf.set("dfs.client.use.datanode.hostname","true");
                conf.set("dfs.data.transfer.protection","authentication");
                conf.set("fs.defaultFS",defaultFS);
                UserGroupInformation.setConfiguration(conf);
                UserGroupInformation.loginUserFromKeytab("hive/ip-172-17-53-122.ec2.internal@EXAMPLE.COM",
