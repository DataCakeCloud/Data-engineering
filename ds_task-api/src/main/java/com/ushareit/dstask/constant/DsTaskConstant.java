...
public class DsTaskConstant extends CommonConstant {
    ...
    public static final String SCHEDULER_URL_PROD = "http://ds-pipeline.datacake.cloud";
    public static final String SCHEDULER_URL = "http://ds-pipeline-{0}.datacake.cloud";

    public static final String GCS = "https://www.googleapis.com/storage/v1/b/";
    public static final String KS = "http://{0}.ks3-cn-beijing.ksyuncs.com/{1}";
    public static final String OSS = "https://{0}.oss-cn-beijing.aliyuncs.com/{1}";
    ...
    public static final String OBS_AWS_PATH_PATTERN = "(obs|s3a|s3|gs|ks3|oss)://([^\\/]*)/(.*)";
    ...
    public static final String OSS_ADDRESS_PATTERN = "(https://([-A-Za-z0-9_.]+).oss-([-A-Za-z0-9_.]+).aliyuncs.com)(:[a-zA-Z0-9]*)?/(.*)/(.+)";
     ...
     * obs相关
     */
    public static final String UPLOAD_OBS_ADS_GIT_PATH = "https://cbs-flink-sg.obs.ap-southeast-3.myhuaweicloud.com/main-sg2-prod/git/";
    ...
    public static final String SCMP_URL_IAM = "https://openapi.ushareit.me/user/api/v1/aksk/iam";
    public static final String SCMP_GET_TOKEN_URL = "https://sentry.ushareit.me/dex/token";
    public static final String SCMP_DELETE_DEPLOYMENT_URL = "http://prod.openapi-hulk.sgt.sg2.api/hulk/openapi/api/v2/apps/{0}/deployment/{1}";
    public static final String SCMP_USERNAME = "092A5096EBDE49CDA65920B8280F6712";
    public static final String SCMP_PASSWORD = "865948E1AFEB270330FB4E3FEED01881";
    public static final String SCMP_GRANT_TYPE = "password";
    public static final String SCMP_SCOPE = "openid groups";
    public static final String SCMP_CLIENT_ID = "sgt-scmp-hulk";
    public static final String SCMP_CLIENT_ID_USER = "sgt-user";
    ...
    public static final String IT_SYSKEY_TEST = "bigdata_467c999a39f9995b74b6";
    public static final String IT_SYSSECRET_TEST = "4a5adfc7577046379de8fe35e6284ed4";

    public static final String IT_SYSKEY = "bigdata_fc35970de0124c3e";
    public static final String IT_SYSSECRET = "0cfbb359526845fd950b0deb2368684f";
    ...
    public static final String METRICS_URL = "https://shareit-hawkeye-viewer.ushareit.me/d/flink-operator-hebe/flink-operator-hebe?orgId=1&kiosk=tv&var-job_id={0}";
    public static final String PERJOB_METRICS_URL = "https://shareit-hawkeye-viewer.ushareit.me/d/flink-operator-hebe-perjob/flink-operator-hebe-perjob?orgId=1&kiosk=tv&var-app={0}&var-job_id={1}";
    public static final String LOG_URL = "https://shareit-hawkeye-viewer.ushareit.me/explore?orgId=1&kiosk=tv&left=[\"now-5m\",\"now\",\"{0}\",'{'\"metrics\":['{'\"type\":\"logs\"'}'],\"query\":\"labels.app:{1}\"'}']";

    public static final String LOG_URL_FRONT="https://shareit-hawkeye-viewer.ushareit.me/explore?orgId=1&kiosk=tv&left=";
    ...
    public static final String UE1_HIVE_LOCATION = "s3://sprs-qz-dw-prod-ue1/datacake/";
    public static final String SG1_HIVE_LOCATION = "s3://sprs-common-data-sg1/datacake/";
    public static final String SG2_HIVE_LOCATION = "obs://sprs-dw-sg/datacake/";
    public static final String SG3_HIVE_LOCATION = "gs://bdp-poc-test/datacake/";
    ...
    public static String DINGDING_SECRET = "SEC6692f1cab1461d2164f49e795fad427f1680aa85d4d85ce564ed22d0bc6245cb";
    public static String DINGDING_WEBHOOK = "https://oapi.dingtalk.com/robot/send?access_token=93925c6d9792d90e448634433ca6c4afcc22062b08b52ac09fa665e022eb24b6";

    // TODO test
    public static String DINGDING_WORKORDER_SECRET_TEST = "SEC904bcb8238c8d668b67cf9b262e186e3843096c8b191536e3c70dd99a173fc8c";
    public static String DINGDING_WORKORDER_WEBHOOK_TEST = "https://oapi.dingtalk.com/robot/send?access_token=c35f8ee42b6c3ac9713e37a563e1eb9db5fb1b999af7c1d0567aaf084def3867";

    /**
     * CoCo
     */
    public static String DINGDING_WORKORDER_SECRET = "SECd156ca178c486c91605430d9366a11665094e2d97e5e0e11fb94efc093d50f6e";
    public static String DINGDING_WORKORDER_WEBHOOK = "https://oapi.dingtalk.com/robot/send?access_token=40f9c0da77c6e6a44b0fde6bb98bfe3d63b2e6a55925da03980cb0fdf7dc3dae";
