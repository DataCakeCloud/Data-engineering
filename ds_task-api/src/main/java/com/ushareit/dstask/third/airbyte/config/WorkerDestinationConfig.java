...
public class WorkerDestinationConfig implements Serializable
{
    ...
    private State state;
    private final static long serialVersionUID = 4689127792842666255L;
