...
public class SCMPServiceImpl implements SCMPService {
    ...
    private static final String TOKEN_URL = "http://sentry.ushareit.me/dex/token";
    private static final String USERNAME = "E2D5B634C0AD419C907F82554E6F05BE";
    private static final String PASSWORD = "CCBE780C653FBEA1D776998763623AE3";

    /**
     * 值班信息，配置在 SCMP 平台
     */
    private static final Integer PLAN_ID = 767;
    private static final String PLAN_URL = "https://openapi.ushareit.me/oncall/api/v1/schedule/pid/" + PLAN_ID;
    private static final String MEMBER_URL = "https://openapi.ushareit.me/oncall/api/v1/oncallmembers/brief?group=BDP";
