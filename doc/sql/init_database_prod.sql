...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER ON `ds_task_${tenantName}`.* TO 'ds_task'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER ON `gov_${tenantName}`.* TO 'gov'@'%';
