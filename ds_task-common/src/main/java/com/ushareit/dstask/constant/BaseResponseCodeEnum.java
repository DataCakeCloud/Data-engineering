...
public enum BaseResponseCodeEnum {
    ...
    TASK_GET_LOG_FAIL("任务提交获取日志失败"),
    TASK_DEL_FORMAT_ERROR("依赖jar格式有误"),
    ...
    OSS_CLIENT_GET_FAIL("OSS客户端获取失败"),
    OSS_LIST_FAIL("OSS列出对象失败"),
    OSS_UPLOAD_FAIL("更新jar包到OSS失败"),
    OSS_DOWNLOAD_FAIL("OSS下载JAR失败"),
    OSS_DELETE_FAIL("从OSS删除对象失败"),
    ;
